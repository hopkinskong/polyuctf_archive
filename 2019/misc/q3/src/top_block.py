...
# Title: Top Block
# Generated: Sat Oct 26 17:22:51 2019
##################################################
...
class top_block(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.blocks_wavfile_source_0 = blocks.wavfile_source('/home/hopkins/Downloads/morse (2).wav', True)
        self.blocks_multiply_xx_0 = blocks.multiply_vff(1)
        self.blocks_multiply_const_vxx_0 = blocks.multiply_const_vff((1.2, ))
        self.analog_sig_source_x_0_0_0 = analog.sig_source_f(8e3, analog.GR_COS_WAVE, 200, 1, 0)
        self.analog_sig_source_x_0 = analog.sig_source_f(8e3, analog.GR_COS_WAVE, 1000, 1, 0)
